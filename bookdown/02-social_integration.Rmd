...
Vänskapsband mellan grupper är en viktig indikation på social integration och när vi frågade våra elever i årskurs 8 om deras fem bästa vänner ställda vi bland annat frågan om dessa vänner har svensk eller utländsk bakgrund. I Figur \@ref(fig:avg-foreign-friends) ser vi vilken andel av de fem bästa vännerna som har utländsk bakgrund, uppdelat på kön och bakgrund. I genomsnitt är knappt en femtedel av vännerna till unga med svensk bakgrund av utländsk bakgrund medan andelen är betydligt högre för unga med utländsk bakgrund (runt 70% för flickor och 60% för pojkar). 
...
En uppenbar delförklaring till skillnaden i andelen gruppöverskridande vänskapsband är gruppernas storlek och på boende- och skolsegregation. I Figur \@ref(fig:foreign-friends-context) tar vi delvis höjd för detta genom att se hur andelen vänner med utländsk bakgrund varierar beroende på hur många i skolan som har utländsk bakgrund. Vi ser en genomgående trend att när andelen med utländsk bakgrund i skolan är större så är också andelen vänner med utländsk bakgrund det. Denna trend syns för både unga med svensk respektive utländsk bakgrund samt för både pojkar och flickor. Samtidigt så ser vi att för varje given andel av med utländsk bakgrund i skolan så har unga med svensk bakgrund färre vänner med utländsk bakgrund än de unga i generation 2 och generation 1. 
...
Genom att bryta upp ovanstående resultat efter kön blir det tydligt att det finns en könsdimension till etnisk partnerval. I Figur \@ref(fig:f5-11) ser vi att bland de grupper som i lägst grad sammanbor med någon av svenskt ursprung, så är det framförallt drivet av att unga kvinnor oftare har partners från samma bakgrund. Denna skillnaden mellan män och kvinnor kan inte förklaras av etnisk segregation utan har kanske att göra med att för kvinnor så gäller traditionella normer i högre utsträckning.
...
Slutligen så har vi också tittat på inter-etnisk integration i parförhållanden genom en uppdelning i fyra grupper: partners med svensk bakgrund, partners med samma bakgrund som en själv, partners med bakgrund i samma region (men inte samma land) som en själv och partner med bakgrund i en annan region. Det vi ser i Figur \@ref(fig:f5-13) är att bland som har en partner med bakgrund från ett annat land så kommer de ofta från samma region. Särskilt tydligt är det för de vars föräldrar är födda i Libanon eller Syrien. 
...
Vid 19-års ålder ställdes frågan "Hur ofta har du känt att du blivit dåligt behandlad under de senaste tolv månaderna, på grund av... (1) ditt kön, (2) din etniska eller nationella bakgrund, (3) din ålder, (4) annat skäl", med svarsalternativ från "aldrig" till "en eller flera gånger i veckan". I Figur \@ref(fig:discrimination-orig) ser vi hur stor andelen som blivit utsatt för dålig behandling av någon anledning, uppdelat på ursprungsregioner. Där ser vi att skillnaden mellan grupperna inte är särskilt stor. 
...
Att samtliga grupper uppger ungefär lika grad av diskriminering förklaras av att unga med svensk bakgrund i högre utsträckning upplever sig dåligt behandlade på grund av kön eller ålder och om vi tittar på upplevelser av dålig behandling på grund av etnisk eller nationell bakgrund ser vi att unga med utländsk bakgrund i högre utsträckning upplever sig utsatta, vilket illustreras i Figur \@ref(fig:discrimination-ethn). Unga med bakgrund i Mellanöstern och Afrika anger högst grad av diskriminering på denna delfråga, där 22-25% av dem har upplevt sådan diskriminering minst en gång i månaden. 
