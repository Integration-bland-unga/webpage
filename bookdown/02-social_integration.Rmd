...
```{r f5-21, echo=FALSE, warning=FALSE, fig.cap="Attityder till olika etniska grupper bland unga med svensk (övre delen) respektive utländsk bakgrund (nedre delen). Attityden till den grupp man själv tillhör har räknats bort", fig.asp = 1.4}
tar_read(p_f5_21)
```
