...
```{r f6-7, echo=FALSE, warning=FALSE, fig.asp = 1.2, fig.cap="Förändringen mellan åldrarna 14 och 16 i etnisk identifiering (svensk/annan) upp- födda i Sverige, sämre svenskkunskaper än unga med svensk bakgrund, vilket delat på ursprungsregion."}
tar_read(p_f6_7)
```
